...
/**
 * print_magic - prints elf header content
 * @h: elf 64 header
 * Return: void
 */
void print_magic(Elf64_Ehdr h)
{
	...
	for (i = 0; i < EI_NIDENT; i++)
		printf("%.2x%c", h.e_ident[i], i == EI_NIDENT - 1 ? '\n' : ' ');
}

/**
 * print_class - prints elf header content
 * @h: elf 64 header
 * Return: void
 */
...
/**
 * print_data - prints elf header content
 * @h: elf 64 header
 * Return: void
 */
...
/**
 * print_version - prints elf header content
 * @h: elf 64 header
 * Return: void
 */
...
/**
 * print_type - prints elf header content
 * @h: elf 64 header
 * Return: void
 */
...
/**
 * print_entry - prints elf header content
 * @h: elf 64 header
 * Return: void
 */
